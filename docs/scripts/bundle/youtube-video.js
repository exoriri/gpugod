...
(function () {
  ...
  }); // scripts/youtube-video.js


  var import_plyr = __toESM(require_plyr_min());

  var player = new import_plyr["default"]("#player-youtube-darya");
  var invisibleClickable = document.querySelector(".invisible-clickable");
  var youtubeIframe = document.querySelector(".greeting__video");
})();