...
(function () {
  ...
  var TweenMaxWithCSS = gsapWithCSS.core.Tween; // node_modules/tslib/modules/index.js
  ...
  var scrollToBlock = function scrollToBlock() {
    ...
    var srollToBlock = function srollToBlock(e) {
      ...
      e.stopPropagation();
      e.preventDefault();
      var foundSection = document.getElementById(destinationSection);
      gsapWithCSS.to(window, {
        duration: 2,
        scrollTo: {
          y: destination,
          offsetY: foundSection.getBoundingClientRect().y < 0 && (destinationSection === "doubts" || destinationSection === "benefits") ? foundSection.offsetHeight * 2 : 0
        }
      });
