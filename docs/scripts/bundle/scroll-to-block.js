...
(function () {
  ...
  _getGSAP3() && gsap3.registerPlugin(ScrollTrigger2); // scripts/scroll-to-block.js

  var scrollToBlock = function scrollToBlock() {
    var headerLinks = document.querySelectorAll(".header__links-text");
    var headerLinksMobile = document.querySelectorAll(".section-content__list-text");
    ...
    headerLinksMobile.forEach(function (link) {
